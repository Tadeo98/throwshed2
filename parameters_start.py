...
def main():
    #######################################################################
    ## PATHS
    dem_path = r"D:\School\STU_SvF_BA\Term11\Dizertacna_praca\data\dem\dtm.tif" #path to DEM
    point_layer_path = r"D:\School\STU_SvF_BA\Term11\Dizertacna_praca\data\point\point2.shp"   #path to point layer
    line_layer_path = r"D:\School\STU_SvF_BA\Term11\Dizertacna_praca\data\line\lines3.shp" #path to line layer
    throwshed_output_folder = r"D:\School\STU_SvF_BA\Term11\Dizertacna_praca\data\history\31_08_2024"  #path to folder, where the file will be saved
    throwshed_file = r"throwshed_parallel_classic5"   #name of output throwshed file
    ...
    cores = 1 #number of cores allocated for multiprocessing, 0-n, where 0 means all cores
    ...
    initial_velocity = 20 #initial velocity of projectile when shot [m/s]
    temperature = 15 #air temperature at shooting site [°C]
    air_density = 1.058 #air density [kg/m^3]
    ...
    wall_width = 5 #obstacle/wall width (if obstacle option is used) [m]
    ...
    throwshed2.main(dem_path, point_layer_path, line_layer_path, throwshed_output_folder, throwshed_file, throwshed_mode, use_viewshed,
             ...
             initial_height, initial_velocity, drag_to_mach, temperature, diameter, mass, cross_sectional_area, azimuth_min, azimuth_max,
