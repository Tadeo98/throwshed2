...
def main():
    ...
    line_layer_path = r"D:\School\STU_SvF_BA\Term11\Dizertacna_praca\data\line\lines2.shp" #path to line layer
    throwshed_output_folder = r"D:\School\STU_SvF_BA\Term11\Dizertacna_praca\data\history\28_08_2024"  #path to folder, where the file will be saved
    throwshed_file = r"throwshed_ditches"   #name of output throwshed file
    ...
    use_lines = 1 #utilization of line layer, where lines serve as obstacles or walls and will be burnt into DEM, No = 0, Yes = 1
    ...
    azimuth_min = 135 #minimum of the azimuth range [°]
